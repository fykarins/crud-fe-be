  ...
  definition: {
    ...
    paths: {
      ...
      "/Mayor": {
        "get": {
          "tags": ['Mayor'],
          summary: 'Get All Students Mayor',
          description: '',
          responses: {
            '200': {
              description: 'a successful response',
      ...
      "/Mayor/{GET}": {
        "get": {
          "tags": ['Mayor'],
          summary: 'Get One Students Mayor',
          description: '',
          responses: {
            '200': {
              description: 'a successful response',
